...
* category[ilcore].coding contains cml 0..1 and mv 0..1
* category[ilcore].coding[cml].system 1..1
* category[ilcore].coding[cml].system = "http://fhir.ashmc.co.il/cs/cml-diag-category" (exactly)
* category[ilcore].coding[cml].code 0..1
* category[ilcore].coding[cml].display 0..1
...
* code.coding[cml].system = "http://fhir.ashmc.co.il/cs/cml-diag-code" (exactly)
* code.coding[cml].code 1..1
* code.coding[cml].display 0..1
* code.coding[mv].system 1..1
* code.coding[mv].system = "http://fhir.ashmc.co.il/cs/mv-diag-code" (exactly)
* code.coding[mv].code 1..1
* code.coding[mv].display 0..1
